...
if (isset($_POST['media-submit']))
{
    if(empty($_POST['title_of_media']) || empty($_POST['type_of_media']) || empty($_POST['desc_of_media'])) {
        ...
        $query = "INSERT INTO media(type, name, description, category, isUnlocked) VALUES('".$type."','".$title."','".$description."','".$category."', 0)";

        $result = $connection->query($query);
        if($result)
        {
            $notifier_text = "This media item has been added to your 'bucket' list";
                        ...
                        <div class="col-lg-12">
                            <form id="login-form" action="" method="post" role="form" style="display: block;">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <input type="submit" name="media-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Save to bucket">
                                        </div>
                                    </div>
                                </div>
                            </form>
